...
//Set Link 
$link = "http://weather.yahooapis.com/forecastrss?w=27409058";
//Get lat and long
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Glenmorangie distillery</title>
    ...
    <body onload="initialize()" onunload="GUnload()">
        ...
        $getfield = "?q=glenmorangie&count=10";
